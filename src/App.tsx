          ...
          <div className="grid md:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src="/src/assets/images/regenerated_image_1777882474553.jpg" 
                  alt={PROFILE.name} 
                ...
                >
                  ...
                  {project.id === "02" ? (
                    ...
                    <div className="w-full md:w-1/2 grid grid-cols-2 gap-4 py-6">
                      {[
                        { src: "/src/assets/images/regenerated_image_1777971707699.png", rotate: "-1deg" },
                        { src: "/src/assets/images/regenerated_image_1777971710809.png", rotate: "1.5deg" },
                        { src: "/src/assets/images/regenerated_image_1777971713441.png", rotate: "0.2deg" },
                        { src: "/src/assets/images/regenerated_image_1777971717206.png", rotate: "-0.5deg" }
                      ].map((item, i) => (
                        <motion.div 
                          key={i}
